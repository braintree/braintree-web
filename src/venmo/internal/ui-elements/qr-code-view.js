...
var QRCodeView = /** @class */ (function (_super) {
    ...
    function QRCodeView(options) {
        ...
        _this.qrCodePlaceholder = _this.$("#venmo-qr-code-view__code-container-placeholder");
        _this.qrCodeContainer = _this.$("#venmo-qr-code-view__code-container-qr-code");
        return _this;
    }
