...
- Report a [vulnerability](https://github.com/braintree/braintree-web/security/advisories/new) directly via private vulnerability reporting on GitHub
...
Only the latest release series receives patches and new versions in the case of a security issue. See our [deprecation policy](https://developer.paypal.com/braintree/docs/guides/client-sdk/deprecation-policy/) for details.
...
For details on supported platform versions, see our [deprecation policy](https://developer.paypal.com/braintree/docs/guides/client-sdk/deprecation-policy/).
