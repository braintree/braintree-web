...
import { amexRewardsBalanceErrorHandler } from "../../../msw/services/gateway";

const waitForAmexReady = async (page: Page): Promise<void> => {
...
test.describe("American Express - Rewards Balance Network Error", function () {
  test.beforeEach(async ({ getTestUrl, page, network }) => {
    network.use(amexRewardsBalanceErrorHandler);
