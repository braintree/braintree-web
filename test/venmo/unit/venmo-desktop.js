...
describe("VenmoDesktop", function () {
  ...
  beforeEach(function () {
    ...
    Framebus.mockImplementation(function () {
      return {
        on: vi.fn().mockImplementation(function (eventName, cb) {
    ...
    venmoOptions = {
      ...
      verifyDomain: vi.fn().mockReturnValue(true),
      apiRequest: vi.fn(),
      sendEvent: vi.fn(),
    };
  });
  ...
  function mockFramebusWithEvent(eventName, payload) {
    Framebus.mockImplementation(function () {
      return {
        on: vi.fn().mockImplementation(function (name, cb) {
          if (name === eventName) {
            cb(payload);
          }
  ...
  describe("initialize", function () {
    ...
    it("calls startPolling when VENMO_DESKTOP_REQUEST_NEW_QR_CODE fires", function () {
      ...
      vi.spyOn(instance, "startPolling").mockImplementation(function () {});
  ...
  describe("launchDesktopFlow", function () {
    beforeEach(function () {
      vi.spyOn(VenmoDesktop.prototype, "startPolling").mockImplementation(
        function () {}
      );
      Framebus.mockImplementation(function () {
        return {
  ...
  describe("startPolling", function () {
    ...
    beforeEach(function () {
      vi.spyOn(VenmoDesktop.prototype, "triggerCompleted").mockImplementation();
      vi.spyOn(VenmoDesktop.prototype, "pollForStatusChange").mockResolvedValue(
        {
      ...
      vi.spyOn(VenmoDesktop.prototype, "displayQRCode").mockImplementation();
    });

    it("creates payment context with CreateVenmoPaymentContext mutation", function () {
      venmoOptions.apiRequest = vi
        .fn()
    ...
    it("triggers rejection for unhandled errors", function () {
      ...
      vi.spyOn(instance, "triggerRejected").mockImplementation();
    ...
    it("triggers rejection when createVenmoDesktopPaymentContext fails", function () {
      ...
      venmoOptions.apiRequest = vi.fn().mockRejectedValue(error);
  ...
  describe("pollForStatusChange", function () {
    ...
    it("resolves if no payment context id", function () {
      ...
      vi.spyOn(instance, "displayError").mockImplementation();
    ...
    it("continues to poll every second until terminal status", function () {
      ...
      useFakeTimers();
      vi.spyOn(instance, "pollForStatusChange");
    ...
    it("calls authorizing on SCANNED", function () {
      ...
      useFakeTimers();
      vi.spyOn(instance, "authorizing").mockImplementation();
    ...
    it("calls authorize on APPROVED", function () {
      ...
      useFakeTimers();
      vi.spyOn(instance, "authorize").mockImplementation();
  ...
  describe("triggerCompleted", function () {
    ...
    it("noops when hidden", function () {
      return createInitializedInstance().then(function (instance) {
        ...
        var spy = (instance.completedHandler = vi.fn());
