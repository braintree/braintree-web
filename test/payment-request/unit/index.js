...
describe('paymentRequest', () => {
  ...
  describe('create', () => {
    beforeEach(() => {
      ...
      jest.spyOn(PaymentRequestComponent.prototype, 'initialize').mockResolvedValue({});
      jest.spyOn(createDeferredClient, 'create').mockResolvedValue(testContext.fakeClient);
    });

    it('returns a promise', () => paymentRequest.create({ client: testContext.fakeClient }));

    it('verifies with basicComponentVerification', () => paymentRequest.create({
    ...
    it('can create with an authorization instead of a client', () => paymentRequest.create({
    ...
    it('instantiates a Payment Request integration', () => paymentRequest.create({
      client: testContext.fakeClient
    }).then(instance => {
      expect(instance).toBeDefined();
    }));
