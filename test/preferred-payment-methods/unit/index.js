...
describe('preferredPaymentMethods.create', () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(PreferredPaymentMethods.prototype, 'initialize').mockResolvedValue();
  });
  ...
  it('initializes component', () =>
    create({ client: testContext.client }).then(() => {
      expect(PreferredPaymentMethods.prototype.initialize).toHaveBeenCalledTimes(1);
      expect(PreferredPaymentMethods.prototype.initialize).toHaveBeenCalledWith({ client: testContext.client });
    }));
});
