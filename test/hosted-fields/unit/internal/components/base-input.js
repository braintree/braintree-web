  ...
  describe.each(Object.keys(constants.allowedFields))("%p", (key) => {
      ...
      describe("attributes", () => {
        ...
        describe("prefill", () => {
          it("applies prefill provided", () => {
            ...
            expect(testContext.model.set).toHaveBeenCalledWith(
        ...
        describe("placeholder", () => {
          it("applies if provided", () => {
            ...
            expect(instance.element.getAttribute("placeholder")).toBe(
              key.toUpperCase()
            );
          });
          ...
          it("does not apply if not defined", () => {
            expect(
              testContext.instance.element.getAttribute("placeholder")
            ).toBeNull();
          });
        });
        ...
        describe("defaults", () => {
          ...
          it("applies autocomplete", () => {
            expect(
              testContext.instance.element.getAttribute("autocomplete")
            ).toBeDefined();
            expect(
              testContext.instance.element.getAttribute("autocomplete")
            ).not.toBe("off");
          ...
          it("applies autocorrect", () => {
            expect(
              testContext.instance.element.getAttribute("autocorrect")
            ).toBe("off");
          });

          it("applies autocapitalize", () => {
            expect(
              testContext.instance.element.getAttribute("autocapitalize")
            ).toBe("none");
          });

          it("applies spellcheck", () => {
            expect(
              testContext.instance.element.getAttribute("spellcheck")
            ).toBe("false");
          });

          it("applies name", () => {
            expect(testContext.instance.element.getAttribute("name")).toBe(
              constants.allowedFields[key].name
            );
          });

          it("applies id", () => {
            expect(testContext.instance.element.getAttribute("id")).toBe(
              constants.allowedFields[key].name
            );
          });
        });
        ...
        describe("class", () => {
          it("applies as type", () => {
            expect(testContext.instance.element.getAttribute("class")).toBe(
              key
            );
          });
        });
        ...
        describe("data-braintree-name", () => {
          it("applies based on type", () => {
            expect(
              testContext.instance.element.getAttribute("data-braintree-name")
            ).toBe(key);
          });
        });
        ...
        describe("setAttribute", () => {
          ...
          it("calls element.setAttribute", () => {
            ...
            expect(
              testContext.instance.element.setAttribute
        ...
        describe("removeAttribute", () => {
          ...
          it("calls element.removeAttribute", () => {
            ...
            expect(
              testContext.instance.element.removeAttribute
    ...
    describe("model listeners", () => {
      ...
      it("calls render when isValid change event fires", () => {
        ...
        expect(instance.model.on).toBeCalledWith(
          eventName,
          expect.any(Function)
        );
      ...
      it("resets the placeholder after applying autofill if placedholder exists", () => {
        ...
        expect(instance.element.setAttribute).toBeCalledWith(
          "placeholder",
          "foo"
        );
      });
